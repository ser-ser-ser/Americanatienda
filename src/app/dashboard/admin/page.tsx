...
const TrafficChart = () => (
    <div className="relative w-full h-[250px] mt-6 flex flex-col justify-end">
        ...
        <div className="relative flex-1 w-full">
            ...
            <div className="absolute inset-x-0 top-1/2 h-[1px] bg-white/5 border-dashed border-b border-white/5" />
            ...
            {steps.map((step, i) => (
                <div key={i}>
                    ...
                    <div className="h-3 bg-zinc-900 rounded-sm overflow-hidden relative">
                        ...
                        <div className="absolute right-[10%] top-0 h-full w-[1px] bg-white/10 border-r border-dashed border-white/20" />
                    </div>
                </div>
            ))}
...
const DemographicsMap = () => (
    <div className="h-[300px] w-full bg-[#0D0D0D] border border-white/5 relative rounded-lg overflow-hidden flex items-center justify-center group">
        ...
        <div className="absolute bottom-8 right-8 bg-[#000]/90 border border-zinc-800 p-4 rounded-lg w-40 z-20 backdrop-blur-md">
