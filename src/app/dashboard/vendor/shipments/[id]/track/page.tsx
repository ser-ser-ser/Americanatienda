...
export default function VendorTrackingPage() {
    ...
    useEffect(() => {
        const fetchOrder = async () => {
            // Mock Data logic preserved for consistency/demo purposes
            if (id === 'ORD-DEMO-1234' || id.startsWith('AMR-') || id.startsWith('ORD-')) {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-[#050505] text-slate-900 dark:text-white font-sans">
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                {/* Map Section - Identical to Buyer */}
