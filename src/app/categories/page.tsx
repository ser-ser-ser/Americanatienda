    ...
    useEffect(() => {
        const fetchCategories = async () => {
            ...
            if (data) {
                ...
                // link logic: /category/[slug] or similar?
                // Standardizing: The user wants to view products by category?
                // Currently we don't have a /category/[slug] page? We have /shops/[slug]/[categorySlug]...
                // But for GLOBAL marketplace, we need /collections/[slug]?
