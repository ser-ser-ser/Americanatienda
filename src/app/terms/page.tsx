            ...
            <main className="flex-1 pt-32 pb-20 px-6">
                <div className="max-w-3xl mx-auto space-y-12">
                    ...
                    <div className="space-y-4 text-center">
                        ...
                        <p className="text-zinc-500 uppercase tracking-widest text-sm">Americana Tienda &mdash; Última actualización: 10 de Enero, 2026</p>
                    </div>
                    ...
                    <div className="prose prose-invert prose-lg max-w-none space-y-8 text-zinc-300">
                        <p className="lead border-l-2 border-primary pl-6 italic text-xl text-zinc-100">
                            Bienvenido a Americana Tienda. Al acceder a nuestra plataforma, usted acepta estar sujeto a los siguientes términos. Este es un espacio de <strong>Acceso Exclusivo</strong> diseñado para la comercialización de productos de bienestar adulto (Sex Shop) y parafernalia (Smoke Shop).
                        </p>

                        <section className="space-y-4">
                            <h2 className="text-2xl font-serif text-white border-b border-white/10 pb-2">1. Modelo de Marketplace por Invitación</h2>
                            <p>Americana Tienda opera bajo un modelo de <strong>Círculo Cerrado</strong>.</p>
                        ...
                        <section className="space-y-4">
                            ...
                            <p>Americana Tienda es una plataforma tecnológica de intermediación.</p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-zinc-500">
                        ...
                        <section className="space-y-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2 marker:text-zinc-500">
                                ...
                                <li><strong>Cancelación de Cuentas:</strong> Americana Tienda monitorea constantemente el inventario. Nos reservamos el derecho unilateral de cancelar cuentas, retener pagos en disputa o banear de forma permanente a cualquier distribuidor o usuario que infrinja nuestras normas.</li>
                            </ul>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <ul className="list-disc pl-6 space-y-2 marker:text-zinc-500">
                                ...
                                <li><strong>Anonimato:</strong> Sus datos de consumo son privados y no serán compartidos, vendidos ni exhibidos a terceros para fines comerciales externos al ecosistema de Americana Tienda.</li>
                            </ul>
                        </section>

                        <section className="space-y-4">
                            <h2 className="text-2xl font-serif text-white border-b border-white/10 pb-2">5. Propiedad Intelectual</h2>
                            <p>El diseño, la estética Avant-Garde, los videos y la marca "Americana Tienda" son propiedad intelectual exclusiva. Queda prohibida la reproducción total o parcial de nuestra interfaz o concepto visual sin autorización expresa.</p>
                        </section>
